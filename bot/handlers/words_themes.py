...
async def send_dict_start_w(message: types.Message):
    ...
    await message.answer(formatted_dict, parse_mode=ParseMode.MARKDOWN, reply_markup=reply_keyboards.exit_kb)
...
async def send_dict_trip_w(message: types.Message):
    ...
    await message.reply(formatted_dict, parse_mode=ParseMode.MARKDOWN, reply_markup=reply_keyboards.exit_kb)
